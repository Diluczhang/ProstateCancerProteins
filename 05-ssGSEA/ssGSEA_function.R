...
ssGSEA_u <- function(
  ...
  # --------------------------------------------------------- #
  # input.ds = "Matrix_W_combined_signed.gct"
  # output.prefix = "W_Signed"
  # gene.set.databases = "h.all.v7.4.symbols.gmt"
  ...
  #browser()
  write_gct(V.GCT, paste (output.prefix, '-scores.gct', sep=''), appenddim = F)
  ...
  write_gct(P.GCT, paste (output.prefix, '-pvalues.gct', sep=''), appenddim = F)
  ...
  write_gct(F.GCT, paste (output.prefix, '-fdr-pvalues.gct', sep=''), appenddim = F)
  ...
  write_gct(ALL.GCT, paste (output.prefix, '-combined.gct', sep=''), appenddim = F)
